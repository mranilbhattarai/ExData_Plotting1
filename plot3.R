...
with(power,plot(Sub_metering_1~D_and_T,type="l", ylab="Energy sub metering", xlab="", col = "black"))
with(power,lines(Sub_metering_2~D_and_T, ylab="Energy sub metering", xlab="", col = "red"))
with(power,lines(Sub_metering_3~D_and_T, ylab="Energy sub metering", xlab="", col = "blue"))
